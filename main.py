            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-4">
                            <b class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample1" role="button"
                               aria-expanded="false" aria-controls="collapseExample">
                                Как доставить?
                            </b>
                        ...
                        <div class="col-4">
                            <b class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample2" role="button"
                               aria-expanded="false" aria-controls="collapseExample">
                                Какая гарантия?
                            </b>
